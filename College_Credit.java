...
public class College_Credit {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println(name + ", How many of these credits does one take per semester?");
	    ...
	    System.out.println(name +", based on some super complicated math it will take one " + (int)Math.ceil(y) + " semesters to finish your degree which will cost one $" + z + " + don't forget the paper tax I mean stamp act wait I mean tottaly not a scam college textbooks!!!");
